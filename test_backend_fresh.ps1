# Backend API Test Script for PowerShell - Fresh Run with Unique Emails
...
Write-Host "Fresh Run with Unique Emails" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    $body = @{
        email = "attendee_$Timestamp@test.com"
